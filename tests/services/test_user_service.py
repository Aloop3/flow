...
class TestUserService(unittest.TestCase):
    ...
    def setUp(self):
        ...
        with patch('src.services.user_service.UserRepository', return_value=self.user_repository_mock):
    ...
    def test_update_user(self):
        ...
        # Configure mocks
        self.user_repository_mock.update_user.return_value = {"Attributes": {
        ...
        self.user_repository_mock.update_user.assert_called_once_with("user123", update_data)
        self.user_repository_mock.get_user.assert_called_once_with("user123")
    ...
    def test_update_user_not_found(self):
        ...
        self.user_repository_mock.update_user.return_value = {"ResponseMetadata": {"HTTPStatusCode": 200}}
        self.user_repository_mock.get_user.return_value = None
        ...
        self.user_repository_mock.update_user.assert_called_once_with("nonexistent", {"name": "Updated Name"})
        self.user_repository_mock.get_user.assert_called_once_with("nonexistent")
