...
class TestWeekService(unittest.TestCase):
    ...
    def setUp(self):
        ...
        with patch(
            "src.services.week_service.WeekRepository",
            return_value=self.week_repository_mock,
        ), patch(
            "src.services.week_service.DayRepository",
    ...
    def test_get_weeks_for_block_empty(self):
        ...
        # Assert repository was called with correct block ID
        self.week_repository_mock.get_weeks_by_block.assert_called_once_with(
            "empty-block"
        )
    ...
    def test_create_week(self):
        ...
        result = self.week_service.create_week(
            block_id="block123", week_number=1, notes="Test week notes"
        )
    ...
    def test_create_week_without_notes(self):
        ...
        result = self.week_service.create_week(block_id="block123", week_number=1)
    ...
    def test_update_week(self):
        ...
        # Configure mocks
        self.week_repository_mock.update_week.return_value = {
        ...
        self.week_repository_mock.update_week.assert_called_once_with(
            "week123", update_data
        )
        self.week_repository_mock.get_week.assert_called_once_with("week123")
    ...
    def test_update_week_not_found(self):
        ...
        result = self.week_service.update_week(
            "nonexistent", {"notes": "Updated notes"}
        )
    ...
    def test_delete_week(self):
        ...
        self.week_repository_mock.delete_week.return_value = {
            "ResponseMetadata": {"HTTPStatusCode": 200}
        }
    ...
    def test_delete_week_failure(self):
        ...
        self.day_repository_mock.delete_days_by_week.assert_called_once_with(
            "nonexistent"
        )
