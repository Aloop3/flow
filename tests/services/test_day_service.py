...
class TestDayService(unittest.TestCase):
    ...
    def setUp(self):
        ...
        with patch('src.services.day_service.DayRepository', return_value=self.day_repository_mock), \
             patch('src.services.day_service.ExerciseRepository', return_value=self.exercise_repository_mock):
    ...
    def test_update_day(self):
        ...
        # Configure mocks
        self.day_repository_mock.update_day.return_value = {"Attributes": {"notes": "Updated notes for squat day"}}
        ...
        self.day_repository_mock.update_day.assert_called_once_with("day123", update_data)
        self.day_repository_mock.get_day.assert_called_once_with("day123")
    ...
    def test_delete_day(self):
        ...
        self.day_repository_mock.delete_day.return_value = {"ResponseMetadata": {"HTTPStatusCode": 200}}
        
        # Call the service method
        result = self.day_service.delete_day("day123")
        
        # Assert repository methods were called in the correct order with correct ID
        self.exercise_repository_mock.delete_exercises_by_day.assert_called_once_with("day123")
    ...
    def test_update_day_not_found(self):
        ...
        self.day_repository_mock.update_day.return_value = {"ResponseMetadata": {"HTTPStatusCode": 200}}
        self.day_repository_mock.get_day.return_value = None
