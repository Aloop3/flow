...
class TestExerciseService(unittest.TestCase):
    ...
    def setUp(self):
        ...
        with patch('src.services.exercise_service.ExerciseRepository', return_value=self.exercise_repository_mock):
    ...
    def test_get_exercise_not_found(self):
        ...
        # Assert repository was called with correct ID
        self.exercise_repository_mock.get_exercise.assert_called_once_with("nonexistent")
    ...
    def test_update_exercise(self):
        ...
        # Configure mocks
        self.exercise_repository_mock.update_exercise.return_value = {"Attributes": {"sets": 3, "weight": 335.0}}
        ...
        self.exercise_repository_mock.update_exercise.assert_called_once_with("ex123", update_data)
        self.exercise_repository_mock.get_exercise.assert_called_once_with("ex123")
    ...
    def test_delete_exercise(self):
        ...
        self.exercise_repository_mock.delete_exercise.return_value = {"ResponseMetadata": {"HTTPStatusCode": 200}}
