...
class TestBlockService(unittest.TestCase):
    ...
    def setUp(self):
        ...
        with patch('src.services.block_service.BlockRepository', return_value=self.block_repository_mock), \
             patch('src.services.block_service.WeekRepository', return_value=self.week_repository_mock):
    ...
    def test_get_blocks_for_athlete(self):
        ...
        self.block_repository_mock.get_blocks_by_athlete.assert_called_once_with("athlete123")
    ...
    def test_delete_block(self):
        ...
        self.block_repository_mock.delete_block.return_value = {"ResponseMetadata": {"HTTPStatusCode": 200}}
        ...
        self.block_repository_mock.delete_block.side_effect = Exception("Deletion failed")
    ...
    def test_update_block(self):
        ...
        # Configure mocks
        self.block_repository_mock.update_block.return_value = {"Attributes": {"status": "active"}}
        ...
        self.block_repository_mock.update_block.assert_called_once_with("block123", update_data)
        self.block_repository_mock.get_block.assert_called_once_with("block123")
