...
class TestWorkoutRepository(unittest.TestCase):
    ...
    def setUp(self):
        ...
        with patch("boto3.resource", return_value=self.mock_dynamodb), patch(
            "src.repositories.workout_repository.SetRepository",
            return_value=self.mock_set_repository,
        ):
    ...
    def test_get_workout_with_sets(self):
        ...
        self.mock_set_repository.get_sets_by_workout.assert_called_once_with(
            "workout123"
        )
        ...
        mock_workouts = [
            {
                ...
                "date": "2025-03-01",
                "exercises": [{"completed_id": "ex1", "exercise_type": "Squat"}],
            },
            {
                "workout_id": "workout2",
                "athlete_id": "athlete123",
                "date": "2025-03-03",
                "exercises": [{"completed_id": "ex2", "exercise_type": "Bench Press"}],
            },
        ]
    ...
    def test_get_workout_by_day(self):
        ...
        mock_workout = {
            ...
            "day_id": "day789",
            "date": "2025-03-15",
            "exercises": [{"completed_id": "exercise1", "exercise_type": "Squat"}],
        }
    ...
    def test_get_completed_exercises_by_type(self):
        ...
        with patch.object(
            ...
            # Call the method
            result = self.workout_repository.get_completed_exercises_by_type(
                "athlete123", "Squat"
            )
    ...
    def test_create_workout_with_sets(self):
        ...
        expected_workout_data = {
            ...
            "exercises": [
                ...
                {"completed_id": "exercise2", "exercise_type": "Bench Press"},
            ],
        }
    ...
    def test_update_workout_with_exercises_list(self):
        ...
        self.assertEqual(
            call_args["ExpressionAttributeValues"][":exercises"][0]["exercise_type"],
            "Squat",
        )
        self.assertEqual(
            call_args["ExpressionAttributeValues"][":exercises"][1]["exercise_type"],
            "Bench Press",
        )
    ...
    def test_update_workout_without_sets(self):
        ...
        self.assertEqual(
            call_args["ExpressionAttributeValues"][":notes"], "Updated workout notes"
        )
    ...
    def test_delete_workout_with_sets(self):
        ...
        self.mock_set_repository.delete_sets_by_workout.assert_called_once_with(
            "workout123"
        )
