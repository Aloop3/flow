...
class TestExerciseRepository(unittest.TestCase):
    ...
    def test_update_exercise(self):
        ...
        self.table_mock.update_item.return_value = {"Attributes": {"exercise_id": "ex123"}}
        ...
        self.assertIn("set sets = :sets, weight = :weight", call_args["UpdateExpression"])
        self.assertEqual(call_args["ExpressionAttributeValues"], {":sets": 3, ":weight": 335.0})
    ...
    def test_delete_exercise(self):
        ...
        self.table_mock.delete_item.return_value = {"Attributes": {"exercise_id": "ex123"}}
    ...
    def test_delete_exercises_by_workout(self):
        ...
        with patch.object(self.repository, 'get_exercises_by_workout', return_value=exercises_data):
            # Mock the batch_writer context manager
            batch_writer_mock = MagicMock()
            self.table_mock.batch_writer.return_value.__enter__.return_value = batch_writer_mock
            ...
            batch_writer_mock.delete_item.assert_any_call(
                Key={"exercise_id": "ex1"}
            )
            batch_writer_mock.delete_item.assert_any_call(
                Key={"exercise_id": "ex2"}
