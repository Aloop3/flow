...
class TestSetRepository(unittest.TestCase):
    ...
    def test_delete_sets_by_exercise(self):
        ...
        with patch.object(self.set_repository, 'get_sets_by_exercise', return_value=mock_sets):
            # Call the method
    ...
    def test_delete_sets_by_workout(self):
        ...
        with patch.object(self.set_repository, 'get_sets_by_workout', return_value=mock_sets):
            # Call the method
