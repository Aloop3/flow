...
class TestDayRepository(unittest.TestCase):
    ...
    def test_update_day(self):
        ...
        self.assertEqual(call_args["ExpressionAttributeValues"], expected_expression_values)
    ...
    def test_delete_day_by_week(self):
        ...
        with patch.object(self.day_repository, 'get_days_by_week', return_value=mock_days):
