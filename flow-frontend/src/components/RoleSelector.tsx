...
const RoleSelector = ({ user, onRoleSelected }: RoleSelectorProps) => {
  ...
  return (
    <div className="min-h-screen bg-ocean-mist flex flex-col justify-center py-12 sm:px-6 lg:px-8">
      <div className="sm:mx-auto sm:w-full sm:max-w-md">
        <h2 className="mt-6 text-center text-3xl font-bold font-display text-ocean-navy">
          Welcome to Flow
        </h2>
        <p className="mt-2 text-center text-sm text-ocean-slate">
