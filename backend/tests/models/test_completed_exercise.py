...
class TestCompletedExerciseModel(unittest.TestCase):
    ...
    def test_completed_exercise_initialization_without_notes(self):
        ...
        """
        exercise = CompletedExercise(
            completed_id="comp123", workout_id="workout456", exercise_id="ex789"
        )
    ...
    def test_initialization_with_empty_completed_id(self):
        ...
        with self.assertRaises(ValueError) as context:
            CompletedExercise(
                completed_id="", workout_id="workout456", exercise_id="ex789"
            )
    ...
    def test_initialization_with_empty_workout_id(self):
        ...
        with self.assertRaises(ValueError) as context:
            CompletedExercise(
                completed_id="comp123", workout_id="", exercise_id="ex789"
            )
    ...
    def test_initialization_with_empty_exercise_id(self):
        ...
        with self.assertRaises(ValueError) as context:
            CompletedExercise(
                completed_id="comp123", workout_id="workout456", exercise_id=""
            )
    ...
    def test_add_sets_maintains_order(self):
        ...
        self.assertEqual(
            exercise.sets[0].set_id, "set1"
        )  # First is set1 (set_number=1)
        self.assertEqual(
            exercise.sets[1].set_id, "set2"
        )  # Second is set2 (set_number=2)
    ...
    def test_update_set(self):
        ...
        updated_set = exercise.update_set(
            set_id="set123", completed=False, reps=5, weight=286.6, rpe=6.5
        )
