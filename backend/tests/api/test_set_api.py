...
class TestSetAPI(BaseTest):
    ...
    def test_get_set_success(self, mock_set_service):
        ...
        event = {"pathParameters": {"set_id": "set123"}}
        context = {}
    ...
    def test_get_set_not_found(self, mock_set_service):
        ...
        event = {"pathParameters": {"set_id": "nonexistent"}}
        context = {}
    ...
    def test_get_sets_for_exercise_success(self, mock_set_service):
        ...
        event = {"pathParameters": {"exercise_id": "exercise123"}}
        context = {}
    ...
    def test_create_set_failed(self, mock_workout_service):
        ...
        event = {
            "pathParameters": {"exercise_id": "exercise456"},
            "body": json.dumps(
                {"workout_id": "workout789", "reps": 5, "weight": 245.0}
            ),
        }
        context = {}
    ...
    def test_create_set_value_error(self, mock_workout_service):
        ...
        # Setup
        mock_workout_service.add_set_to_exercise.side_effect = ValueError(
            "Invalid data"
        )
    ...
    def test_create_set_exception(self, mock_workout_service):
        ...
        # Setup
        mock_workout_service.add_set_to_exercise.side_effect = Exception(
            "Test exception"
        )
    ...
    def test_update_set_not_found(self, mock_workout_service):
        ...
        event = {
            "pathParameters": {"set_id": "nonexistent"},
            "body": json.dumps({"reps": 6}),
        }
        context = {}
